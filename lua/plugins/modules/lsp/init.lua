return {
	...
	config = function()
		...
		local remaps = require("plugins.modules.lsp.remaps")
		...
		local servers = {
			bashls = require("plugins.modules.lsp.servers.bashls")(on_attach),
			cssls = {},
			dockerls = {},
			eslint = require("plugins.modules.lsp.servers.eslint")(on_attach),
			html = {},
			jsonls = {},
			lua_ls = require("plugins.modules.lsp.servers.luals")(on_attach),
			pylsp = {},
			rust_analyzer = {},
			terraformls = {},
			tflint = {},
			tsserver = require("plugins.modules.lsp.servers.tsserver")(on_attach),
			yamlls = {},
		}
